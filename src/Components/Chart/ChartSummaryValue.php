...
class ChartSummaryValue extends Component
{
    protected string $view = 'filament-flux-pro::components.chart.summary-value';
    ...
    public function fallback(string | Closure | null $fallback): static
    {
