...
class SidebarBrand extends ViewComponent implements SidebarComponent
{
    protected string $viewIdentifier = 'sidebarBrand';

    protected string $view = 'filament-flux-pro::layouts.sidebar.components.sidebar-brand';
