...
class NavbarItem extends ViewComponent implements NavbarComponent
{
    use Concerns\HasExtraAttributes;

    protected string $viewIdentifier = 'navbarItem';

    protected string $view = 'filament-flux-pro::layouts.header.components.navbar-item';
